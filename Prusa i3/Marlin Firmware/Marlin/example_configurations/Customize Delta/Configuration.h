...
#define STRING_CONFIG_H_AUTHOR "(Ko Lin, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "KL Delta"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define DELTA_PROBEABLE_RADIUS (DELTA_PRINTABLE_RADIUS - 35)
...
#define MANUAL_Z_HOME_POS 293 // Distance between the nozzle to printbed after homing
